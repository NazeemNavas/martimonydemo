...
<body>
<?php
 require(__DIR__ .'/class/dbpro.php');
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div>
          <div class="a">
            <a href="sura/newbasic-table.php"> <button type="button" class="btn btn-outline-light btn-fw "><b>Upgrade Now</b></button></a>
        ...
        <div class="j">
          <div class="col-lg-4">
            <div class="img12" >
            <img src="img/22.png" alt="image" class="m1">
            <img src="img/21.png" alt="image" class="m2">
          </div>
            </div>
            <div class="col-lg-8 ">
            <div class="l">
            <div>
              <h3>Name</h3>
              <h>E75656565  |  Profile created by relative</h><br>
              <h style="color: blue;"><i class="mdi mdi-verified"></i> Verified</h>
              
              </div>
              <div class="i">
                <ul>
                <li>27 years and two months,6'0"</li><br>
                <li>Mother tongue is Tamil</li><br>
                <li>Lives in nagercoil</li><br>
                <li>Native Tenkasi</li><br>
                
                </ul>
                <ul class="ui">
                <li>Studied in Nagercoil</li><br>
                <li> Builder</li><br>
                <li>Earns 2.5LPA</li><br>
                </ul>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="container">
                    <div>
                        <h3><i class="mdi mdi-pencil"></i> About him</h3>
                        <p>Im making this profile for my relative.He is self employed.Currently working in nagercoil.He came from middle class family,joint family with orthodax values.</p>
                    </div>
                    <div class="uu">
                        <div>
                        <label ><i class="mdi mdi-human-male"></i> 27 years and two months,6'0"</label>
                        <br><br>
                        <i class="mdi mdi-ring"></i> Unmarried
                        </div>
                        <div class="iii">
                    ...
                    <div>
                        <h3><i class="mdi mdi-temple-hindu"></i>His religious background</h3>
                        <i class="mdi mdi-church"></i> Christian<br><br>
                        <i class="mdi mdi-book"></i> Viswakarma
                    </div><hr>
                    <div >
                        <h3><i class="mdi mdi-tie"></i> His professional details</h3>
                        <div class="d">
                        <div>
                        <i class="mdi mdi-school"></i> Engineer<br><br>
                        <i class="mdi mdi-account-card-details"></i> Selfemployed
                        </div>
                        <div class="jjj">
                        <i class="mdi mdi-wallet-travel"></i> Builder<br><br>
                        <i class="mdi mdi-cash"></i> Earns 2.5LPA
                        </div>
                        </div>
                    </div><hr>
                    <div>
                        <h3><i class="mdi mdi-account-multiple"></i> About his loved ones</h3>
                        <p>Middle class joint family with orthodax values.</p>
                    </div>
                </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="container">
                    ...
                    <div>
                      <h3><i class="mdi mdi-cellphone"></i>Profile verification</h3>
                  ...
                  <div class="container">
                    ...
                    <div>
                      ...
                      <table class="ff">
                          ...
                          <tr><td>Marrital status</td><td>Single</td></tr>
                          <tr><td>Mother tongue</td><td>Tamil</td></tr>
                          <tr><td>Physical status</td><td>Normal</td></tr>
                    ...
                    <div>
                        ...
                        <table class="f">
                            ...
                            <tr><td>Caste</td><td>Viswakarma</td></tr>
                            <tr><td>Subcaste</td><td>Any</td></tr>
                    ...
                    <div>
                        ...
                        <table class="oo">
                            <tr><td>Education</td><td>B.E Computer science and engineering</td></tr>
                            <tr><td>employed in</td><td>Any</td></tr>
                            <tr><td>Occupation</td><td>Any</td></tr>
                            <tr><td>Annual income</td><td>Any</td></tr>
                    ...
                    <div>
                        ...
                        <table class="g">
                            ...
                            <tr><td>Residing state</td><td>Tamilnadu</td></tr>
